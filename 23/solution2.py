...
def biggest_clique(adj, nodes):
	# explore all the maximal cliques... and some more
	res = 0, ()
	stack = [(list(nodes), ())]
	while stack:
		n = res[0]
		nodes, partial = stack.pop()
#		print('-', nodes, partial)
		m = n - len(partial)
		m = max(m + 1, 0)
		best = True
...
#			print('+', new_nodes, new_partial)
			stack.append((new_nodes, new_partial))
		if best:
